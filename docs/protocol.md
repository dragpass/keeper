...
the Commit's authenticated data as `{"v":1,"org_removals":[...],"leaves":[...],
"device_revocations":[...]}`. The committer's signature covers them, so a

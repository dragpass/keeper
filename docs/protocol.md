...
- A Commit this device **builds** is held to the rules from its side:
  ...
  `pending_leaf_replacements` (as before); Automation never sends `user_initiated`. A refusal is

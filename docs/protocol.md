...
|`CHAT_DISPLAY_NOT_AUTHORIZED`|Permit signature, binding, window, or missing group handle. Deliberately one code for all of them — which check refused is not something an unauthorized caller gets to learn.|
